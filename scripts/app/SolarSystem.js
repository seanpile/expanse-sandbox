define(["app/Vector", "app/util/MovingAverage", "moment"],
  function (Vector, MovingAverage, moment) {
    ...
    SolarSystem.prototype.update = function (t, dt) {
      ...
      this.planets.forEach(function (planet) {
...

        {
          ...
          let semiMinorA = new Vector(-a * e, b, 0);
          let semiMinorB = new Vector(-a * e, -b, 0);
          ...
          planet.center = this._transformToEcliptic(center, argumentPerihelion, omega, I);
          planet.periapsis = this._transformToEcliptic(periapsis, argumentPerihelion, omega, I);
          planet.apoapsis = this._transformToEcliptic(apoapsis, argumentPerihelion, omega, I);
          planet.semiMinorA = this._transformToEcliptic(semiMinorA, argumentPerihelion, omega, I);
          planet.semiMinorB = this._transformToEcliptic(semiMinorB, argumentPerihelion, omega, I);
          planet.derivedValues = {
            omega: omega,
